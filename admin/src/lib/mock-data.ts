import type { Member, Role, Permission, MemberHistory, Branch, Store, Department, Product, Part } from './types'
...
export const PRODUCTS: Product[] = [
  ...
  { id: 'P01', productCode: '11000100', barcode: '8809639031001', name: 'HYPEOB-01',      brandCategory: 'GENTLE MONSTER', midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS COMBI',     factory1: 'WZ-A1', factory2: 'SZ-C3', factory3: null,    releaseDate: '2022-03-15', partsRetentionPeriod: '',           stockLocation: 'A1-01', isSafetyStock: true,  quantity: 142, isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1110',  salesStatus: '사용중'       },
  { id: 'P02', productCode: '11000101', barcode: '8809639031018', name: 'HYPEOB-B4',      brandCategory: 'GENTLE MONSTER', midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS COMBI',     factory1: 'WZ-A1', factory2: 'SZ-C3', factory3: null,    releaseDate: '2022-03-15', partsRetentionPeriod: '',           stockLocation: 'A1-01', isSafetyStock: true,  quantity: 98,  isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1110',  salesStatus: '사용중'       },
  { id: 'P03', productCode: '11000200', barcode: '8809639032001', name: 'LILIT-01',        brandCategory: 'GENTLE MONSTER', midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS ACETATE',   factory1: 'WZ-A1', factory2: null,    factory3: null,    releaseDate: '2023-04-01', partsRetentionPeriod: '',           stockLocation: 'A1-02', isSafetyStock: true,  quantity: 215, isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1110',  salesStatus: '사용중'       },
  { id: 'P04', productCode: '11000201', barcode: '8809639032018', name: 'LILIT-B4',        brandCategory: 'GENTLE MONSTER', midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS ACETATE',   factory1: 'WZ-A1', factory2: null,    factory3: null,    releaseDate: '2023-04-01', partsRetentionPeriod: '',           stockLocation: 'US-A1', isSafetyStock: false, quantity: 133, isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: 'C1002', salesStatus: '사용중'       },
  { id: 'P05', productCode: '11000300', barcode: '8809639033001', name: 'SWAY-01',         brandCategory: 'GENTLE MONSTER', midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS ACETATE',   factory1: 'SZ-C3', factory2: 'WZ-B2', factory3: null,    releaseDate: '2023-06-20', partsRetentionPeriod: '2028-03-01', stockLocation: 'A1-03', isSafetyStock: false, quantity: 88,  isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1110',  salesStatus: '종료 예정'    },
  { id: 'P06', productCode: '11000400', barcode: '8809639034001', name: 'MASTER-01',       brandCategory: 'GENTLE MONSTER', midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS METAL',     factory1: 'WZ-A1', factory2: null,    factory3: null,    releaseDate: '2021-09-01', partsRetentionPeriod: '',           stockLocation: 'A1-04', isSafetyStock: true,  quantity: 310, isRestorationRequest: true,  dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1110',  salesStatus: '사용중'       },
  { id: 'P07', productCode: '11000401', barcode: '8809639034018', name: 'MASTER-B4',       brandCategory: 'GENTLE MONSTER', midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS METAL',     factory1: 'WZ-A1', factory2: null,    factory3: null,    releaseDate: '2021-09-01', partsRetentionPeriod: '2027-06-01', stockLocation: 'US-A2', isSafetyStock: true,  quantity: 2,   isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: 'C1002', salesStatus: '판매 종료 (P)' },
  { id: 'P08', productCode: '11000500', barcode: '8809639035001', name: 'ROBOTOS-01',      brandCategory: 'GENTLE MONSTER', midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS COMBI',     factory1: 'WZ-A1', factory2: 'WZ-B2', factory3: 'SZ-C3', releaseDate: '2023-01-25', partsRetentionPeriod: '',           stockLocation: 'A2-01', isSafetyStock: true,  quantity: 178, isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1110',  salesStatus: '사용중'       },
  { id: 'P09', productCode: '11000600', barcode: '8809639036001', name: 'TACHYON-01',      brandCategory: 'GENTLE MONSTER', midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS INJECTION', factory1: 'SZ-C3', factory2: 'WZ-A1', factory3: null,    releaseDate: '2023-09-05', partsRetentionPeriod: '',           stockLocation: 'US-B1', isSafetyStock: true,  quantity: 196, isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: 'C1002', salesStatus: '사용중'       },
  { id: 'P10', productCode: '11000700', barcode: '8809639037001', name: 'DREAMER-01',      brandCategory: 'GENTLE MONSTER', midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS METAL',     factory1: 'WZ-A1', factory2: 'WZ-B2', factory3: 'SZ-C3', releaseDate: '2024-06-01', partsRetentionPeriod: '',           stockLocation: 'US-B2', isSafetyStock: true,  quantity: 237, isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: 'C1002', salesStatus: '사용중'       },
  { id: 'P11', productCode: '11001000', barcode: '8809639041001', name: 'VIBE-01 OPT',     brandCategory: 'GENTLE MONSTER', midCategory: 'OPTICAL',     subCategory: 'OPTICAL COMBI',      factory1: 'WZ-A1', factory2: null,    factory3: null,    releaseDate: '2023-02-28', partsRetentionPeriod: '',           stockLocation: 'B1-01', isSafetyStock: true,  quantity: 120, isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1110',  salesStatus: '사용중'       },
  { id: 'P12', productCode: '11001001', barcode: '8809639041018', name: 'VIBE-B4 OPT',     brandCategory: 'GENTLE MONSTER', midCategory: 'OPTICAL',     subCategory: 'OPTICAL COMBI',      factory1: 'WZ-A1', factory2: null,    factory3: null,    releaseDate: '2023-02-28', partsRetentionPeriod: '2027-12-01', stockLocation: 'B1-01', isSafetyStock: false, quantity: 77,  isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1110',  salesStatus: '종료 예정'    },
  { id: 'P13', productCode: '11001100', barcode: '8809639042001', name: 'COVER-01 OPT',    brandCategory: 'GENTLE MONSTER', midCategory: 'OPTICAL',     subCategory: 'OPTICAL ACETATE',    factory1: 'SZ-C3', factory2: 'WZ-B2', factory3: null,    releaseDate: '2024-01-10', partsRetentionPeriod: '',           stockLocation: 'US-C1', isSafetyStock: false, quantity: 93,  isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: 'C1002', salesStatus: '사용중'       },
  { id: 'P14', productCode: '14000017', barcode: '8809639043001', name: 'STACY-01 OPT',    brandCategory: 'GENTLE MONSTER', midCategory: 'OPTICAL',     subCategory: 'OPTICAL METAL',      factory1: 'WZ-B2', factory2: 'SZ-C3', factory3: null,    releaseDate: '2023-11-15', partsRetentionPeriod: '2028-02-01', stockLocation: 'B1-04', isSafetyStock: true,  quantity: 3,   isRestorationRequest: false, dataSource: 'PS',  registeredBy: 'monster042',  registeredAt: '2023-11-20T10:15:00', branchCode: '1110',  salesStatus: '판매 종료 (P)' },
  { id: 'P15', productCode: '11001300', barcode: '8809639044001', name: 'WIDE-01 OPT',     brandCategory: 'GENTLE MONSTER', midCategory: 'OPTICAL',     subCategory: 'OPTICAL ACETATE',    factory1: 'WZ-A1', factory2: 'WZ-B2', factory3: null,    releaseDate: '2024-03-22', partsRetentionPeriod: '',           stockLocation: 'US-C2', isSafetyStock: true,  quantity: 134, isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: 'C1002', salesStatus: '사용중'       },
  { id: 'P16', productCode: '14000018', barcode: '8809639045001', name: 'CASSOR-01',       brandCategory: 'GENTLE MONSTER', midCategory: 'ACCESSORY',   subCategory: 'CASE',               factory1: 'SH-D4', factory2: null,    factory3: null,    releaseDate: '2023-08-01', partsRetentionPeriod: '2028-01-01', stockLocation: 'C1-01', isSafetyStock: false, quantity: 420, isRestorationRequest: false, dataSource: 'PS',  registeredBy: 'monster001',  registeredAt: '2023-08-05T09:30:00', branchCode: '1110',  salesStatus: '종료 예정'    },
  { id: 'P17', productCode: '14000019', barcode: '8809639046001', name: 'CLEAN KIT-01',    brandCategory: 'GENTLE MONSTER', midCategory: 'ACCESSORY',   subCategory: 'CLEANING KIT',       factory1: 'SH-D4', factory2: null,    factory3: null,    releaseDate: '2023-08-01', partsRetentionPeriod: '',           stockLocation: 'C1-02', isSafetyStock: true,  quantity: 650, isRestorationRequest: false, dataSource: 'PS',  registeredBy: 'monster001',  registeredAt: '2023-08-05T09:45:00', branchCode: '1110',  salesStatus: '사용중'       },
  { id: 'P18', productCode: '12000100', barcode: '8809639051001', name: 'NORSA-01',        brandCategory: 'TAMBURINS',       midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS ACETATE',   factory1: 'WZ-A1', factory2: 'SZ-C3', factory3: null,    releaseDate: '2023-05-10', partsRetentionPeriod: '',           stockLocation: 'A3-01', isSafetyStock: true,  quantity: 89,  isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1210',  salesStatus: '사용중'       },
  { id: 'P19', productCode: '12000101', barcode: '8809639051018', name: 'NORSA-B4',        brandCategory: 'TAMBURINS',       midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS ACETATE',   factory1: 'WZ-A1', factory2: 'SZ-C3', factory3: null,    releaseDate: '2023-05-10', partsRetentionPeriod: '2027-10-01', stockLocation: 'A3-01', isSafetyStock: true,  quantity: 4,   isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1210',  salesStatus: '판매 종료 (C)' },
  { id: 'P20', productCode: '12000200', barcode: '8809639052001', name: 'KENTY-01',        brandCategory: 'TAMBURINS',       midCategory: 'SUNGLASS',    subCategory: 'SUNGLASS COMBI',     factory1: 'WZ-B2', factory2: null,    factory3: null,    releaseDate: '2023-07-20', partsRetentionPeriod: '2028-06-01', stockLocation: 'A3-02', isSafetyStock: false, quantity: 56,  isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1210',  salesStatus: '종료 예정'    },
  { id: 'P21', productCode: '12001000', barcode: '8809639061001', name: 'MINO-01 OPT',     brandCategory: 'TAMBURINS',       midCategory: 'OPTICAL',     subCategory: 'OPTICAL COMBI',      factory1: 'WZ-A1', factory2: null,    factory3: null,    releaseDate: '2024-02-14', partsRetentionPeriod: '',           stockLocation: 'B3-01', isSafetyStock: true,  quantity: 73,  isRestorationRequest: false, dataSource: 'SAP', registeredBy: null,         registeredAt: null,                   branchCode: '1210',  salesStatus: '사용중'       },
  { id: 'P22', productCode: '14000020', barcode: '8809639062001', name: 'CLEO-01 OPT',     brandCategory: 'TAMBURINS',       midCategory: 'OPTICAL',     subCategory: 'OPTICAL METAL',      factory1: 'SZ-C3', factory2: 'WZ-B2', factory3: null,    releaseDate: '2024-04-08', partsRetentionPeriod: '',           stockLocation: 'B3-02', isSafetyStock: false, quantity: 41,  isRestorationRequest: true,  dataSource: 'PS',  registeredBy: 'monster245',  registeredAt: '2024-04-10T14:22:00', branchCode: '1210',  salesStatus: '사용중'       },
]

export const PARTS: Part[] = [
  { id: 'PT01', productCode: '11000100', partCode: 'PT-00001', name: '힌지 (좌)',        category: '힌지',    quantity: 24, status: 'active',   note: '',           registeredBy: 'monster001', registeredAt: '2023-03-10T09:00:00' },
  { id: 'PT02', productCode: '11000100', partCode: 'PT-00002', name: '힌지 (우)',        category: '힌지',    quantity: 24, status: 'active',   note: '',           registeredBy: 'monster001', registeredAt: '2023-03-10T09:05:00' },
  { id: 'PT03', productCode: '11000100', partCode: 'PT-00003', name: '노즈패드',         category: '노즈패드', quantity: 50, status: 'active',   note: '',           registeredBy: 'monster001', registeredAt: '2023-03-10T09:10:00' },
  { id: 'PT04', productCode: '11000200', partCode: 'PT-00004', name: '렌즈 (클리어)',    category: '렌즈',    quantity: 12, status: 'active',   note: 'UV400',      registeredBy: 'monster042', registeredAt: '2023-04-15T10:00:00' },
  { id: 'PT05', productCode: '11000200', partCode: 'PT-00005', name: '힌지 세트',        category: '힌지',    quantity: 18, status: 'active',   note: '',           registeredBy: 'monster042', registeredAt: '2023-04-15T10:10:00' },
  { id: 'PT06', productCode: '11000400', partCode: 'PT-00006', name: '힌지 (좌)',        category: '힌지',    quantity: 8,  status: 'active',   note: '',           registeredBy: 'monster001', registeredAt: '2022-09-20T11:00:00' },
  { id: 'PT07', productCode: '11000400', partCode: 'PT-00007', name: '힌지 (우)',        category: '힌지',    quantity: 8,  status: 'active',   note: '',           registeredBy: 'monster001', registeredAt: '2022-09-20T11:05:00' },
  { id: 'PT08', productCode: '11000400', partCode: 'PT-00008', name: '템플 (좌)',        category: '템플',    quantity: 5,  status: 'active',   note: '',           registeredBy: 'monster001', registeredAt: '2022-09-20T11:15:00' },
  { id: 'PT09', productCode: '11000400', partCode: 'PT-00009', name: '템플 (우)',        category: '템플',    quantity: 5,  status: 'active',   note: '',           registeredBy: 'monster001', registeredAt: '2022-09-20T11:20:00' },
  { id: 'PT10', productCode: '11001000', partCode: 'PT-00010', name: '렌즈 (클리어)',    category: '렌즈',    quantity: 20, status: 'active',   note: '',           registeredBy: 'monster042', registeredAt: '2023-03-01T09:00:00' },
  { id: 'PT11', productCode: '11001000', partCode: 'PT-00011', name: '렌즈 (그레이)',    category: '렌즈',    quantity: 15, status: 'active',   note: '',           registeredBy: 'monster042', registeredAt: '2023-03-01T09:10:00' },
  { id: 'PT12', productCode: '11001000', partCode: 'PT-00012', name: '나사 세트',        category: '나사',    quantity: 100,status: 'active',   note: 'M1.4×2.5',  registeredBy: 'monster042', registeredAt: '2023-03-01T09:20:00' },
  { id: 'PT13', productCode: '14000017', partCode: 'PT-00013', name: '렌즈 (클리어)',    category: '렌즈',    quantity: 6,  status: 'active',   note: '',           registeredBy: 'monster042', registeredAt: '2023-11-22T10:00:00' },
  { id: 'PT14', productCode: '14000017', partCode: 'PT-00014', name: '힌지 세트',        category: '힌지',    quantity: 4,  status: 'active',   note: '',           registeredBy: 'monster042', registeredAt: '2023-11-22T10:10:00' },
  { id: 'PT15', productCode: '12000100', partCode: 'PT-00015', name: '노즈패드',         category: '노즈패드', quantity: 30, status: 'active',   note: '',           registeredBy: 'monster245', registeredAt: '2023-06-01T14:00:00' },
  { id: 'PT16', productCode: '12000100', partCode: 'PT-00016', name: '힌지 (좌)',        category: '힌지',    quantity: 0,  status: 'inactive', note: '단종',        registeredBy: 'monster245', registeredAt: '2023-06-01T14:10:00' },
]
