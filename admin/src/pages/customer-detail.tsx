...
const STATUS_LABELS: Record<TicketStatus, string> = {
  ...
  PAYMENT_DONE: '결제완료',
  PARTNER_SENT: '협력사발송',
  PARTNER_RECEIVED: '협력업체 입고 후 검수 중',
  REPAIRING: '수리중',
  REPAIR_DONE: '수리완료',
  READY_TO_SHIP: '발송준비',
  SHIPPING: '발송중',
  ...
  CANCELED: '취소',
  PICKUP_WAITING: '접수',
  STORE_ARRIVED: '매장 도착(Drop-off)',
  PICKUP_COMPLETED: '픽업 완료',
  PRODUCT_MOVING: '제품 이동 중',
  PICKUP_DONE: '회수 완료',
  PARTS_READY: '부속품 준비 완료',
}
...
const STATUS_COLOR: Record<TicketStatus, string> = {
  ...
  SERVICE_UNAVAILABLE:'bg-rose-50 text-rose-700',
  ...
  PARTNER_RECEIVED:   'bg-violet-50 text-violet-700',
  ...
  SERVICE_DONE:       'bg-gray-100 text-gray-700',
  CLOSED:             'bg-gray-100 text-gray-600',
  CANCELED:           'bg-red-50 text-red-600',
  PICKUP_WAITING:     'bg-blue-50 text-blue-700',
  STORE_ARRIVED:      'bg-indigo-50 text-indigo-700',
  PICKUP_COMPLETED:   'bg-emerald-50 text-emerald-700',
  PRODUCT_MOVING:     'bg-cyan-50 text-cyan-700',
  PICKUP_DONE:         'bg-emerald-50 text-emerald-700',
